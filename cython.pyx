...
# NOTE: this file is a direct translation of the user's provided
# Python script into a .pyx file with no logic changes. Because the
# original code heavily relies on Python C-extensions (torch, cv2,
# numpy, torchvision), this .pyx keeps the same Python imports and
# code. Cython will compile this file but most time will still be
# spent inside those external libraries.
#
# Save this as `kalmar_fsm_cython.pyx` and follow the build
# instructions provided in the chat to compile.
# ============================================================
