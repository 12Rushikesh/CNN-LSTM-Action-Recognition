...
#Final code for training CNN+LSTM model for video classification with only two classes: normal and picked.
...
MODEL_OUT = r"D:\Rushikesh\project\CNN\LSTM-train\models\kalmar_dataset_split_2sec_clips_CAM1\Newkml3.pth"
# =========================================
...
class VideoDataset(Dataset):
    def __init__(self, root_dir):
        ...
        for cls in CLASSES:
            ...
            for v in glob(os.path.join(class_dir, "*.mp4")):
    ...
    def sample_frames(self, path):
        ...
        # pad last frame if video is short
        while len(frames) < SEQ_LEN:
